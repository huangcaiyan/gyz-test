...
# 去发票列表页面
    ...
    def go_to_invoice_list(self):
        ...
        self.driver.get(self.base_url + '/app/invoice/' + self.invoice_type +
                        '-invoice')
        time.sleep(3)
...
# invoice_name:发票类型名称（专票、普票、无票）
    ...
    def select_invoice_type(self):
        ...
        drop_loc = self.driver.find_element_by_xpath(
            ...
            '-invoice/div/div[2]/ul/div[1]/div/label[2]/ng-select')
    ...
    def select_category(self, p_index, c_index):
        ...
        drop_loc = self.driver.find_element_by_xpath(
            '//*[@id="body"]/tab/new-' + self.invoice_type +
            '-invoice/div/div[2]/ul/table/tbody/tr[1]/td[1]/ng-select')
    ...
    def select_partment(self, partment_name):
        ...
        drop_loc = self.driver.find_element_by_xpath(
            '//*[@id="body"]/tab/new-' + self.invoice_type +
            '-invoice/div/div[2]/ul/table/tbody/tr[1]/td[2]/ng-select')
    ...
    def select_tax_rate(self, tax_rate):
        ...
        drop_loc = self.driver.find_element_by_xpath(
            '//*[@id="body"]/tab/new-' + self.invoice_type +
            '-invoice/div/div[2]/ul/table/tbody/tr[1]/td[3]/ng-select')
...
# 点击保存
    ...
    def save(self):
        ...
        btn_loc = self.driver.find_element_by_xpath(
            '//*[@id="body"]/tab/new-' + self.invoice_type +
            '-invoice/div/div[2]/ul/div[3]/div/span/button[2]')
        publicPage.click_elem(btn_loc)
        time.sleep(1)
...
# 点击取消
    ...
    def cancel(self):
        ...
        btn_loc = self.driver.find_element_by_xpath(
            '//*[@id="body"]/tab/new-' + self.invoice_type +
            '-invoice/div/div[2]/ul/div[3]/div/span/button[3]')
        publicPage.click_elem(btn_loc)
        time.sleep(1)
...
# (收票-普票)发票类型、对方信息、类别、部门性质、税率、价税合计、备注
    ...
    def type_input_invoice_general(self, input_invoice_general_info):
        ...
        self.select_category(input_invoice_general_info[2][0],
                             input_invoice_general_info[2][1])
...
# 开票,发票类型、发票状态、对方信息、发票号码、类别、部门性质、税率、总额、备注
    ...
    def type_output_invoice(self, output_invoice_info):
        ...
        self.select_category(output_invoice_info[4][0],
                             output_invoice_info[4][1])
