...
class TestPage:
    ...
    # 登陆成功用户名展示
    def login(self, account[0], account[1]):
        self.driver.get(self.url)
        self.type_username(account[0])
        self.type_password(account[1])
